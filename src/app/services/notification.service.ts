...
export class NotificationService {
  ...
  async markAsRead(id: string): Promise<Notification> {
    ...
    //TODO: check the socketService is working with the container resolve
   ...
   */
  async sendNotificationToUsers(dto: SendNotificationToUsersDto): Promise<Notification[]> {
   ...
   * @returns Promise<void>
   */
  async sendProjectNotification(dto: SendProjectNotificationDto): Promise<void> {
    ...
    const socketService = container.resolve(SocketService);
    socketService.emitToProject(dto.projectId, "project:notification", {
      title: dto.title,
      message: dto.message,
      type: dto.type,
      metadata: dto.metadata,
